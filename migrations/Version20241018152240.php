 ...
 */
final class Version20241018152240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte ADD client_id INT NOT NULL, CHANGE id num_c INT NOT NULL, ADD PRIMARY KEY (num_c)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compte ADD id INT NOT NULL, DROP num_c, DROP client_id');
    }
}
